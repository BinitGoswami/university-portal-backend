...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Check if the header contains a Bearer token. If not, pass to the next filter.
        ...
        // 3. If we found a username and the user is not already authenticated in this session
